...
import os
seed = 777
folder = "./ML_runs_results/temporal/"
folder_model = "./ML_runs_models/temporal/"
VERBOSITY = 6
...
def get_model(model_name):
    ...
    if model_name == "OCSVM":
        ...
        ###### IF #######
# Model parameters
        params={"max_features":[15,25,45], "contamination":np.linspace(0.001,0.05,11)}#[0.17, 0.18,0.19,0.2,0.21] }
...
def run_supervised(model_name,models,X_train,y_train,X_validation,y_validation,X_test,y_test):
    ...
    df_final = pd.concat([df_val, df_test])
    return best_model, df_final
US = ["./temporal_data/US_month_7.csv","./temporal_data/US_month_8.csv","./temporal_data/US_month_9.csv","./temporal_data/US_month_10.csv","./temporal_data/US_month_11.csv","./temporal_data/US_month_12.csv","./temporal_data/US_month_1.csv"]
CN = ["./temporal_data/CN_month_7.csv","./temporal_data/CN_month_8.csv","./temporal_data/CN_month_9.csv","./temporal_data/CN_month_10.csv","./temporal_data/CN_month_11.csv","./temporal_data/CN_month_12.csv","./temporal_data/CN_month_1.csv"]
...
# X_censor_train = X_train[X_train["Label"]!=0]
# print(X_censor_train.shape[0]/(X_censor_train.shape[0]+X_clean_train.shape[0]))




# X_clean_train = X_clean_train.drop(columns = ["Label"])
